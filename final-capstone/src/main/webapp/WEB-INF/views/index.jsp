    ...
    <section id="featured">
      ...
      <div id="nivo-slider">
        <div class="nivo-slider">
          <!-- Slide #1 image -->
          <img src="static/img/slides/slitslider/1.jpg" alt="" title="#caption-1" />
          <!-- Slide #2 image -->
          ...
          <div class="row">
            <div class="span12">
              ...
              <div class="nivo-caption" id="caption-1">
                <div>
                  <h2>Keep A List of Your Shows In One Place!</h2>
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            <div class="big-cta">
              <div class="cta-text">
                <h3>Welcome to TV Show Manager!</h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="span3">
                <div class="box aligncenter">
                  ...
                  <div class="text">
                    <h6>Keep Track of Your Shows</h6>
                  </div>
                </div>
              </div>
              <div class="span3">
